...
NDIS_STATUS OvsAddConfiguredSwitchPorts(PSX_SWITCH_OBJECT sxSwitch,
                                     struct _OVS_SWITCH_CONTEXT *switchContext);
NDIS_STATUS OvsInitConfiguredSwitchNics(PSX_SWITCH_OBJECT sxSwitch,
                                     struct _OVS_SWITCH_CONTEXT *switchContext);

VOID OvsClearAllSwitchVports(PSX_SWITCH_OBJECT sxSwitch,
                             struct _OVS_SWITCH_CONTEXT *switchContext);
